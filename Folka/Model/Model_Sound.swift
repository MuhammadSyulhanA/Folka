...
class Sound {
    ...
    private var soundBacksound: AVAudioPlayer?
    ...
    func playBacksound(file: String, fileExtension: String) {
        ...
        do {
            ...
            soundBacksound = try AVAudioPlayer(contentsOf: url, fileTypeHint: AVFileType.wav.rawValue)
            
            guard let player = soundBacksound else { return }
    ...
    func playDubbing(file: String, fileExtension: String) {
        guard let url = Bundle.main.url(forResource: file, withExtension: fileExtension) else { return }
